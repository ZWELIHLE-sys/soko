...
export function ShopFilters({ categorySlug, initialQ, initialLocationId }: Props) {
  ...
  // sync when server re-renders with new params
  ...
  // Build the /shop URL preserving category, applying updates
