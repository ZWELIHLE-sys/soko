import { Gavel, Store, Package, CheckCircle2, XCircle } from 'lucide-react'
import type { LucideIcon } from 'lucide-react'

export type Stage = 'MARKET' | 'AUCTION' | 'SHOP' | 'SOLD' | 'RETIRED'
...
export const FILTERS: ('ALL' | Stage)[] = ['ALL', 'MARKET', 'AUCTION', 'SHOP', 'SOLD', 'RETIRED']
