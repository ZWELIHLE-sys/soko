...
export default function SellerDashboard() {
  ...
  useEffect(() => {
    fetch('/api/seller/stats').then(r => r.json()).then(setStats)
  }, [])
  ...
  return (
    <div>
      ...
      <div className={styles.harvest}>
        ...
        <h2 className={styles.harvestTitle}>Your craft is your income. Vuna is your stage.</h2>
        <p className={styles.harvestText}>
          Every sale you make on Vuna is a direct payment from a buyer who chose
          your work over everything else. No middlemen. No factories. Just your
          hands and your story reaching the world.
        </p>
